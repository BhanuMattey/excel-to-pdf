...
const CheckoutPage = () => {
  ...
  const planDetails = {
    ...
    pro_yearly: { 
      ...
      price: 7999, 
      currency: '₹', 
      billingCycle: 'Billed yearly (Save 33%)',
      planId: 'pro_yearly'
    },
    team_monthly: { 
      name: 'Team Plan', 
  ...
  // Get plan ID from location state or default to pro_monthly
  const planId = location.state?.planId || 'pro_monthly'
  const currentPlan = planDetails[planId] || planDetails.pro_monthly
        ...
        async (response) => {
          ...
          try {
            ...
            if (verificationResponse.success) {
              ...
              const basePlan = planId.split('_')[0] // 'pro' or 'team'
  ...
  const includedFeatures = [
    ...
    'AI-powered OCR for scanned files',
      ...
      <header className="bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
          <Link to="/" className="flex items-center space-x-2">
            ...
            <span className="text-xl font-bold text-gray-900">ExcelfromPDF</span>
          </Link>
          ...
          <div className="lg:col-span-3">
            ...
            >
              ...
              <p className="text-gray-600 mb-8">
                Unlock unlimited AI-powered PDF to Excel conversions instantly.
              </p>
