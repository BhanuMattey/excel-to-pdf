...
const AuthPromptModal = ({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) => {
        ...
        >
          ...
          <div className="text-center">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-3">
              Unlock 2 More Free Conversions!
            </h2>
            ...
            <div className="space-y-3 mb-8 text-left">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <p className="text-sm font-medium text-gray-900">2 More Free Conversions</p>
                  <p className="text-xs text-gray-500">Get 5 total free conversions, no card required</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500">Files are not stored for more than 24 hours</p>
                </div>
              </div>

              <div className="flex items-start space-x-3">
                <div className="flex-shrink-0 w-5 h-5 bg-brand-teal-100 rounded-full flex items-center justify-center mt-0.5">
                  <Clock className="w-3 h-3 text-brand-teal-700" />
                </div>
                <div>
